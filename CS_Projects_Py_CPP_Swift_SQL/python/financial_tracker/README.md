...
#### Video Demo: [https://youtu.be/ADTTBTIekmY](https://youtu.be/ADTTBTIekmY)

**Track Your Stocks from the Terminal with Python (No API Keys!)**

<a href="https://youtu.be/ADTTBTIekmY">
  <img src="https://img.youtube.com/vi/ADTTBTIekmY/maxresdefault.jpg" width="720" />
</a>

[![Watch on YouTube](https://img.shields.io/badge/▶%20Watch%20on%20YouTube-FF0000?style=for-the-badge&logo=youtube&logoColor=white)](https://youtu.be/ADTTBTIekmY)
...
I created this project for the CS50P final requirement, and it focuses on practical skills: safely consuming external data, validating user input, handling network errors, and presenting results in a professional CLI format.
...
This is my CS50P final project, built to simplify the workflow while I focus on reliable data fetching, input checks, and clean CLI output.
